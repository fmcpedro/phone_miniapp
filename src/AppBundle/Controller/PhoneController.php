...
class PhoneController extends Controller
{
    ...
    public function indexAction()
    {
     ...
     /**
     * Lists Phones by Brand Id.
     *
     * @Route("/search-brand/{brandId}", name="search_brand")
     * @Method({"GET", "POST"})
     */
    public function findPhoneByBrandIdAction($brandId){
        $em = $this->getDoctrine()->getManager();
        $phones= $em->getRepository('AppBundle:Phone')->findPhonesByBrand($brandId);
        $brands=$em->getRepository('AppBundle:Brand')->findAll();
        return $this->render('phone/index.html.twig', array(
            'phones' => $phones, 'brands'=> $brands));
    }
